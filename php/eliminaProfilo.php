<div class="well well-lg">
	  <form role="form" method="POST" action="php/eliminaProfilo-exe.php">
		<h1 align="center"><b>ATTENZIONE!</b></h1><br/><br/>
		<p style="text-align:center; font-size:24px;">Eliminando l'account si elimineranno tutti i dati connsessi al profilo.
